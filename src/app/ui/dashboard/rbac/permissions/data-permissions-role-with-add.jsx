        ...
        <div>
            <div className="flex items-center py-4 gap-3">
                <Input
                    ...
                    value={(table.getColumn("permissionsName")?.getFilterValue()) ?? ""}
                    onChange={(event) =>
                        table.getColumn("permissionsName")?.setFilterValue(event.target.value)
                    }
                    className="max-w-sm"
                />
                <DropdownMenu>
            ...
            <PermissionsOperationDialog open={open} setOpen={setOpen} data={""} add={true}></PermissionsOperationDialog>
